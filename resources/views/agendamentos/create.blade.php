...
<html lang="en">
    ...
    <body style="background-color: #CCCCCC;">
        <div class="container" style="background-color: #FFFFFF;">
            ...
            <div class="row">
                <form action="{{ route('registrar_servico') }}" method="POST" style="padding: 0px 30px 20px 30px;">
                    @csrf
                    <div class="mb-3">
                        &nbsp;
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" required name="telefone" class="form-control" id="telefone" placeholder="(XX) XXXX-XXXX">
                    </div>
                    <div class="mb-3">
						<label for="inputState" class="form-label">Origem:</label>
						<select id="origem" required name="origem" class="form-select">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="data_contato" class="form-control" required id="dataContato">
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label">Observação:</label>
                        <textarea type="text" required name="observacao" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                    </div>
